  ...
  ({
    ...
    const setError = useCallback(
      (nextError: Error | null) => {
        setErrorState({ jsx: processedJsx, error: nextError })
      },
      [processedJsx]
    )
...
export const JSXPreviewContent = memo(
  ({ className, ...props }: JSXPreviewContentProps) => {
    ...
    const [errorSignature, setErrorSignature] = useState<string | null>(null)
    const [lastGoodJsx, setLastGoodJsx] = useState(processedJsx)
    ...
    const handleError = useCallback(
      (err: Error) => {
        ...
        if (errorSignature === processedJsx) {
          return
        }
        setErrorSignature(processedJsx)
      ...
      [errorSignature, processedJsx, isStreaming, onErrorProp, setError]
    )
