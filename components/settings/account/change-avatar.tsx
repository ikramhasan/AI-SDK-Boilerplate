...
export function ChangeAvatar({ className }: ChangeAvatarProps) {
  ...
  const generateUploadUrl = useMutation(api.userAvatars.generateUploadUrl)
  const finalizeUpload = useMutation(api.userAvatars.finalizeUpload)
  const deleteCurrentAvatar = useMutation(api.userAvatars.deleteCurrent)
  ...
  async function handleFileChange(e: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const { imageUrl } = await finalizeUpload({ storageId })
